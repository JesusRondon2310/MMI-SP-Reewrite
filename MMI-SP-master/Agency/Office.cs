...
namespace MMI_SP.Agency
{
    class Office
    {
        ...
        private void BuildOffice()
        {
            ...
            {
                if (npc.Exists())
                    officeCamera.PointAt(npc.Bones[31086]);
        ...
        internal void NpcSay(SpeechType type)
        {
            ...
            // Cambiamos el Hash manual por el nombre estable en la Build 3275
            npc.PlayAmbientSpeech(speech.Name, speech.Voice, (SpeechModifier)Enum.Parse(typeof(SpeechModifier), speech.Param));
