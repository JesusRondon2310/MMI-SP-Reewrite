...
namespace MMI_SP.iFruit
{
    ...
    class MenuConfig
    {
        ...
        private static readonly System.Drawing.Point _offset = new System.Drawing.Point((int)(GTA.UI.Screen.Width * 0.565f), (int)(GTA.UI.Screen.Height * 0.2f));
        ...
        internal void Show()
        {
            ...
            Function.Call((Hash)0xFC695459D4D0E219, 0.5f, 0.5f);    // Cursor position centered
        }
